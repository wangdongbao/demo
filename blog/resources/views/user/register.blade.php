    ...
    <div class="registerCon">
        ...
        <ul>
            <li class="accAndPwd">
                ...
                <dl>
                    <s class="password"></s>
                    <input class="pwd" maxlength="11" name="user_pwd" type="text" placeholder="6-16位数字、字母组成"  />
                    <input class="pwd" maxlength="11" name="user_pwd" type="password" placeholder="6-16位数字、字母组成"  style="display: none"/>
                ...
                <dl>
                    <input class="code"  maxlength="11"  type="text" placeholder="请确认验证码" value="" />
