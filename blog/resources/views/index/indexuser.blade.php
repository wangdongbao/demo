...
@section('content')
    ...
    <div class="sub_nav marginB person-page-menu">
        <a href="{{url('order/buyrecord')}}"><s class="m_s1"></s>潮购记录<i></i></a>
        <a href="/v44/member/orderlist.do"><s class="m_s2"></s>获得的商品<i></i></a>
        <a href="{{url('order/willshare')}}"><s class="m_s3"></s>我的晒单<i></i></a>
        <a href="{{url('order/mywallet')}}"><s class="m_s4"></s>我的钱包<i></i></a>
